...
public class ConversationFragment extends Fragment {
    static final String TAG = ConversationFragment.class.getSimpleName();
    protected Conversation conversation;

    static enum INPUT_TYPE {TEXT, AUDIO}
    ...
    private ImageButton mMediaButton, mAudioRecordButton, mSendButton;
    ...
    private OnClickListener mMediaButtonListener = new OnClickListener() {
        @Override
        public void onClick(View v) {
            if (inputType.equals(INPUT_TYPE.TEXT)) {
                inputType = INPUT_TYPE.AUDIO;

                mMediaButton.setImageResource(R.drawable.ic_keyboard);

                mEditMessage.setVisibility(View.GONE);
                mAudioRecordButton.setVisibility(View.VISIBLE);

            } else if (inputType.equals(INPUT_TYPE.AUDIO)) {
                inputType = INPUT_TYPE.TEXT;

                mMediaButton.setImageResource(R.drawable.ic_sound);
    ...
    public View onCreateView(final LayoutInflater inflater,
        ...
        mMediaButton = (ImageButton) view.findViewById(R.id.textMediaButton);
        mMediaButton.setOnClickListener(this.mMediaButtonListener);

        mAudioRecordButton = (ImageButton) view.findViewById(R.id.audioRecordButton);
        mAudioRecordButton.setOnTouchListener(mAudioRecordListener);
