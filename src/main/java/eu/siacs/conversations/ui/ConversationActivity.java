    ...
    private void selectPresenceToAttachFile(final int attachmentChoice) {
        selectPresence(getSelectedConversation(), new OnPresenceSelected() {
            ...
            public void onPresenceSelected() {
                Log.i(TAG, "onPresenceSelected attachmentChoice=" + attachmentChoice);
    ...
    protected void onActivityResult(int requestCode, int resultCode,
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUEST_DECRYPT_PGP) {
                ...
                Log.i(TAG, "xmppConnectionServiceBound=" + xmppConnectionServiceBound + " mPendingFileUri=" + mPendingFileUri);
                if (xmppConnectionServiceBound) {
                    attachFileToConversation(getSelectedConversation(), mPendingFileUri);
                    mPendingFileUri = null;
                }
