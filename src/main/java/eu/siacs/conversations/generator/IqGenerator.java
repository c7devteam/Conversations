...
public class IqGenerator extends AbstractGenerator {
    ...
    public IqPacket discoRequest(Account account) {
    ...
    public IqPacket setAvatar0153(Avatar avatar) {
        IqPacket iqPacket = new IqPacket(IqPacket.TYPE.SET);
        Element photo=iqPacket.addChild("vCard", "vcard-temp").addChild("PHOTO");
